...
**Current release: 0.10.0** — see [CHANGELOG.md](CHANGELOG.md) for the update history.
...
- Particle effects: all 154 shipped particle emitters and billboards play inside skills (fire, smoke, sparks, rings, status auras, projectile trails), with an SFX browser tab to play any of them on its own
